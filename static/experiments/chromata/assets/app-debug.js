        ...
        link: {
            value: function link(scope, element) {
                ...
                function select() {
                    ...
                    underline.style.top = target.offsetTop + target.clientHeight + "px";
        ...
        link: {
            value: function link(scope, element) {
                var imageElement,
                    ...
                    fileSelect = element[0].querySelector("#file-select"),
                    chromata;
                ...
                scope.saveImage = function (e) {
                    ...
                    bgContext.fillStyle = scope.config.backgroundColor;
                    bgContext.fillRect(0, 0, bgCanvas.width, bgCanvas.height);

                    bgContext.drawImage(canvas, 0, 0, bgCanvas.width, bgCanvas.height);
        ...
        items: {
            get: function () {
                return [{
                    ...
                    title: "fractal",
                    image: "assets/images/fractal.jpg",
                    bgcolor: "#000",
                    credit: "https://www.flickr.com/photos/ogcodes/375282783",
                    config: {
                        pathFinderCount: 40,
                        speed: 15,
                        lineWidth: 1,
                        origin: ["45% 50%"],
                        outputSize: "container",
                        turningAngle: Math.PI * 1.75
                    }
                }, {
                    title: "lines",
                    image: "assets/images/bridge.jpg",
                    bgcolor: "#ffffff",
                    credit: "https://www.flickr.com/photos/shebta/5638858199",
                    config: {
                        pathFinderCount: 40,
                        speed: 8,
                        lineWidth: 2,
                    ...
                    bgcolor: "rgba(70,0,10,1)",
                    credit: "https://www.flickr.com/photos/horwath/8187588812/",
                    config: {
                        pathFinderCount: 30,
                        speed: 3,
                        lineWidth: 2,
                        ...
                        origin: ["50% 0%", "50% 99%"],
                        outputSize: "container",
                        turningAngle: 2 * Math.PI
                    }
                }, {
                    title: "halftone",
                    image: "assets/images/face.jpg",
                    bgcolor: "#000000",
                    credit: "https://www.flickr.com/photos/billy_wilson/4659033632/",
                    config: {
                        pathFinderCount: 10,
                        speed: 10,
                        lineWidth: 10,
                    ...
                    title: "neon",
                    image: "assets/images/hong_kong.jpg",
                    bgcolor: "black",
                    credit: "https://www.flickr.com/photos/tschaut/522958030",
                    config: {
                        pathFinderCount: 30,
                        speed: 3,
                        turningAngle: Math.PI / 2,
                    ...
                    bgcolor: "rgb(63, 124, 63)",
                    credit: "https://www.flickr.com/photos/37796451@N00/4820561313/",
                    config: {
                        pathFinderCount: 60,
                        speed: 4,
                        turningAngle: 2 * Math.PI,
                        origin: ["45% 70%", "85% 50%", "70% 35%"],
                        lineWidth: 4,
                        lineMode: "square",
                        colorMode: "greyscale",
                        key: "high",
